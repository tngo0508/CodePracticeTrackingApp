...
namespace CodePracticeTrackingApp.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            if (!_roleManager.RoleExistsAsync(Constant.Role_Student).GetAwaiter().GetResult())
            {
            ...
            // populate the dropdown list using projection
            Input = new()
            {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        await _userManager.AddToRoleAsync(user, Constant.Role_SWE);
                    }
            ...
            // Need to repopluate the dropdown list again
            Input = new()
            {
                RoleList = _roleManager.Roles.Select(x => x.Name).Select(i => new SelectListItem
                {
